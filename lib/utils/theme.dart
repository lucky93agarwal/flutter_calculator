...
import 'package:foodappui/utils/color.dart';
import 'package:foodappui/utils/config.dart';
...
class ThemeModel {
  final lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1: TextStyle(color: Color(0xffafb0bc), fontSize: 13,letterSpacing: 1.0, fontWeight: FontWeight.w900,),
